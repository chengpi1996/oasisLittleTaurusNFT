...
abstract contract IERC721Receiver {
  function onERC721Received(address operator,address from,uint256 tokenId,bytes memory data) virtual public returns(bytes4);
}
...
contract ERC721 is ERC165, IERC721 {
  ...
  */
   ...
   */
  function _addTokenTo(address to, uint256 tokenId) virtual internal {
   ...
   */
  function _removeTokenFrom(address from, uint256 tokenId) virtual internal {
...
contract ERC721Enumerable is ERC165, ERC721, IERC721Enumerable {
   ...
   * @param tokenId uint256 ID of the token to be added to the tokens list of the given address
   */
  function _addTokenTo(address to, uint256 tokenId) virtual override internal {
   ...
   * @param tokenId uint256 ID of the token to be removed from the tokens list of the given address
   */
  function _removeTokenFrom(address from, uint256 tokenId) virtual override internal {
   ...
   * @param tokenId uint256 ID of the token to be minted by the msg.sender
   */
  function _mint(address to, uint256 tokenId) virtual override internal {
...
contract ERC721Full is ERC721, ERC721Enumerable, ERC721Metadata {
  ...
  function _addTokenTo(address to, uint256 tokenId) virtual override(ERC721,ERC721Enumerable) internal {
    super._addTokenTo(to,tokenId);
  }
  function _mint(address to, uint256 tokenId) virtual override(ERC721,ERC721Enumerable) internal {
    super._mint(to,tokenId);
  }
  function _burn(address owner, uint256 tokenId) virtual override(ERC721,ERC721Enumerable,ERC721Metadata) internal {
    super._burn(owner,tokenId);
  }
  function _removeTokenFrom(address from, uint256 tokenId) virtual override(ERC721,ERC721Enumerable) internal {
    super._removeTokenFrom(from,tokenId);
  }
}
...
contract LittleTaurusNFT is ERC721Full, ERC721Mintable {
  constructor() ERC721Full("Little Taurus", "LT") public {
  }
  function _addTokenTo(address to, uint256 tokenId) override(ERC721,ERC721Full) internal {
    super._addTokenTo(to,tokenId);
  }
  function _mint(address to, uint256 tokenId) override(ERC721,ERC721Full) internal {
    super._mint(to,tokenId);
  }
  function _burn(address owner, uint256 tokenId) override(ERC721,ERC721Full) internal {
    super._burn(owner,tokenId);
  }
  function _removeTokenFrom(address from, uint256 tokenId) override(ERC721,ERC721Full) internal {
    super._removeTokenFrom(from,tokenId);
  }
